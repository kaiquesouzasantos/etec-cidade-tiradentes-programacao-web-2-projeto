...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Nov-2022 às 15:24
...
(2, 'rwrewrewrw', '51248547829', 'fdfdsfdfsderewr@dsadsad', '2343243243', '23213123', 432432, 'rewrwerew', 'erewr', 'werwer', 're', 'werwerewrr', 1, 'pro_08.png'),
(3, 'testeOpa', '51248547829', 'fdfdsfdfsderewr@dsadsad', 'qwewqewq', 'teste teste', 123, 'rwerewrwerewr', 'wqewqewqe', 'Sao Paulo', 'SP', '08470-790', 0, 'IMG-20220425-WA0009.jpg');
...
--
ALTER TABLE `tbcategoria`
  MODIFY `codCategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
