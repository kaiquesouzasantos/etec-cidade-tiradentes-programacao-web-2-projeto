...
<!DOCTYPE html>
<html lang="pt-br">
<?php ViewController::getHead("assets/css/style.css"); ?>
<body>
<!--==================== HEADER ====================-->
...
<main class="main">
        ...
        <div class="home__container container grid">
            ...
            <div class="home__data">
                ...
                <div class="home__btns">
                    <a href="#produtos" class="button button--gray button--small" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='black'">Relógios</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!--==================== SOBE ====================-->
    <section class="story sectionR container" id="quemsomos">
