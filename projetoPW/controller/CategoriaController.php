        ...
        public static function listaCategoria(){
            ...
            foreach($categorias as $categoria){
                ...
                <tr>    
                    ...
                    <td>
                        <a href="#'.$categoria->getCodCategoria().'" class="form-control btn btn-danger"><i class="bx bx-trash-alt"></i></a>
                    </td>
                    <td>
                    <td>
                        <a href="#'.$categoria->getCodCategoria().'" class="form-control btn btn-warning"><i class="bx bx-pencil"></i></a>
                    </td>
                </tr>';
            }
