        ...
        public static function listaProdutosDash(){
            ...
            foreach($produtos as $produto){
                ...
                <tr>
                    ...
                    <td>
                        <a href="#'.$produto->getCodProduto().'" class="form-control btn btn-danger"><i class="bx bx-trash-alt"></i></a>
                    </td>
                    <td>
                    <td>
                        <a href="#'.$produto->getCodProduto().'" class="form-control btn btn-warning"><i class="bx bx-pencil"></i></a>
                    </td>
                <tr>
                ');
            }
