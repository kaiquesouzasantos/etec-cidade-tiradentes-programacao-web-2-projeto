<?php
    ...
    class ProdutoDAO {
        ...
        public static function cadastrarProduto($nome, $preco, $desc, $codCategoria, $imagem){
            ...
            $insertProduto = "INSERT INTO tbProduto(nomeProduto, precoProduto, descProduto, codCategoria, imgProduto) 
                                VALUES (:nome, :preco, :desc, :categoria, img)";
            ...
            $stmt->bindValue(":desc", $produto->getDescricaoProduto());
